    ...
    return (
        <>
            ...
            <div className="home-container2">
                <center><h1 className='headings'>Why Choose <span>Us</span></h1></center>
                <div id="content">
                    <div className="contents">
                        <img src={img7} alt="" />
                        <br />
                        <h3>Choose a <span>Template</span></h3>
                    </div>
                    <div className="contents">
                        <img src={img8} alt="" />
                        <br /><br />
                        <h3>Fill your <span>Details</span></h3>
                    </div>
                    <div className="contents">
                        <img src={img5} alt="" />
                        <br />
                        <h3>Download your <span>Resume</span></h3>
                    </div>
                </div>
            </div>

            <div className="home-container3">
                <center><h1 className='headings'>Importance Of A Good <span>Resume</span></h1></center>
                <div className="contents">
                    <div className="image">
