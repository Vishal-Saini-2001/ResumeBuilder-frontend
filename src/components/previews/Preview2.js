    ...
    <div id="bg">
      ...
      <div className="previewContainer">
        <div className="scroll-resume">
          <Template2 ref={componentRef} personal={personal} education={education} courses={courses} intern={internships} hobbies={hobbies} skills={skills} social={social} aim={aim} />
        </div>
      </div>
    </div>
